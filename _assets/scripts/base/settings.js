...
const cookiesBox = `
    <dialog open class="cookie-popup" id="cookie-popup">
        <p style="margin: 0 0 5px 0;">
            ...
            You can read our privacy policy <a href="/rules/privacy/">here</a>.
        </p>
        <form method="dialog">
...
// `meta`, `root` and `darkThemeEnabled` are declared globally by _assets/scripts/theme.js,
...
function mikuEasterEgg() {
    ...
    style.textContent = `
        ...
        .day.selected::before {
            ...
            background-image: url("/_assets/media/calendar/mikuheadshake.avif");
...
function mkwEasterEgg() {
    ...
    const fontPath = "/_assets/css/webfonts/RacersDelight.woff2"
