        ...
        for (const entry of sortedMatches) {
            ...
            <div class="event-container">
                <div class="team-box-container">
                    ...
                    ${entry.testMatch ? `<div class="test-match-overlay"></div>` : `<img class="team-background-overlay" src="/_assets/media/calendar/event_box_overlay.avif"
                    alt="Team background overlay"
                    onload="this.style.opacity=1" loading="lazy"/>`}

                    ${isLive ? `<div class="test-match-indicator"><span style="display:flex"><div class="live-dot"></div>Live</span></div>` : `<div class="test-match-indicator" id="matchCountdown${entry.eventID}"><i class="fa-solid fa-clock"></i> ${timeUntilMatch}</div>`}
