...
sheet.replaceSync(`
    ...
    .footer-links-wrapper {
        margin: 50px auto;
        width: 80vw;
        max-width: 100% - env(safe-area-inset-left);
        text-align: left;
        display: flex;
    }
...
<div id="divider-container">
    <div id="chequered-pattern"></div>
</div>
<div class="footer-links-wrapper" translate="no">
...
<div class="footer-end">
    ...
    <div class="footer-end-wrapper">
        ...
        <div class="social-wrapper translate="no">
            ...
            <a class="no-color-link no-underline-link-footer" href="https://www.youtube.com/@universitymariokartleague" title="UMKL YouTube Channel">
            ...
            <a class="no-color-link no-underline-link-footer" href="https://www.instagram.com/universitymariokartleague" title="UMKL Instagram Account">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.859 2.071c-1.064.05-1.791.22-2.425.469a4.917 4.917 0 0 0-1.77 1.157 4.917 4.917 0 0 0-1.15 1.772c-.246.637-.413 1.365-.46 2.428l-.053 4.122.069 4.122c.051 1.064.22 1.791.469 2.426a4.9 4.9 0 0 0 1.157 1.769 4.917 4.917 0 0 0 1.774 1.15c.636.246 1.363.413 2.427.46L12.02 22l4.122-.068c1.067-.05 1.789-.221 2.425-.469a4.917 4.917 0 0 0 1.769-1.157 4.917 4.917 0 0 0 1.15-1.774c.246-.636.413-1.363.459-2.427l.052-4.123-.067-4.122c-.05-1.067-.22-1.79-.47-2.426a4.917 4.917 0 0 0-1.156-1.769 4.883 4.883 0 0 0-1.773-1.15c-.637-.245-1.363-.413-2.428-.458l-4.122-.055-4.122.07m.117 18.077c-.975-.042-1.504-.204-1.857-.34a3.083 3.083 0 0 1-1.152-.746 3.083 3.083 0 0 1-.75-1.148c-.137-.352-.302-.882-.347-1.857l-.067-4.04.051-4.04c.042-.974.205-1.504.34-1.857a3.11 3.11 0 0 1 .746-1.152 3.083 3.083 0 0 1 1.149-.75c.353-.138.881-.301 1.856-.348l4.04-.067 4.042.052c.973.042 1.503.203 1.856.34.467.18.8.396 1.152.746s.567.681.75 1.148c.137.352.302.88.348 1.856l.067 4.04-.051 4.04c-.043.975-.204 1.504-.34 1.858a3.09 3.09 0 0 1-.747 1.15 3.083 3.083 0 0 1-1.148.75c-.352.137-.882.302-1.855.348l-4.042.066c-2.671.006-2.985-.005-4.04-.05m8.152-13.493a1.2 1.2 0 1 0 1.198-1.202 1.2 1.2 0 0 0-1.198 1.202m-9.262 5.355a5.135 5.135 0 1 0 10.269-.02 5.135 5.135 0 0 0-10.269.02m1.801-.003a3.333 3.333 0 1 1 3.34 3.327 3.333 3.333 0 0 1-3.34-3.327"></path>
                </svg>
            </a>
            
            <a class="no-color-link no-underline-link-footer" href="https://www.facebook.com/profile.php?id=61575273336011" title="UMKL Facebook Page">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="margin-left:-1px">
                    <path d="M9.584 21.706v-6.65H7.522V12h2.062v-1.317c0-3.404 1.54-4.982 4.882-4.982.334 0 .796.035 1.223.086a7.5 7.5 0 0 1 .951.162v2.771a7.5 7.5 0 0 0-.544-.03 22.5 22.5 0 0 0-.611-.008c-.589 0-1.049.08-1.396.258a1.417 1.417 0 0 0-.566.518c-.215.35-.312.829-.312 1.46V12h3.266l-.322 1.752-.239 1.303h-2.705v6.871C18.163 21.328 22 17.113 22 12c0-5.522-4.478-10-10-10S2 6.478 2 12c0 4.69 3.228 8.625 7.584 9.706"></path>
                </svg>
            </a>
...
// NEED TO FIGURE OUT HOW TO MAKE THE LOGO COLOUR DYNAMIC
// THE RED LOGO IS ACCEPTABLE ON A WHITE BACKGROUND, BUT IS NOT ACCEPTABLE ON AN BLACK BACKGROUND
