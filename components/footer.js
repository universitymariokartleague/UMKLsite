...
class UMKLFooter extends HTMLElement {
    constructor() {
        ...
        template.innerHTML = `
            ...
            <div translate="no">
                © UMKL 2025 |
                <a id="credits-link" class="no-color-link" href="../../../pages/credits/">Credits</a> |
    ...
    connectedCallback() {
        ...
        if (currentPath.endsWith("credits")) {
            const creditsLink = shadow.getElementById("credits-link");
            creditsLink.innerText = "Sitemap"
            creditsLink.href = "../pages/sitemap/"
        }
    }
}
