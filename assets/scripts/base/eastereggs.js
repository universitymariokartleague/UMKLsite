...
function injectMusic(path) {
    ...
    link.rel = 'stylesheet';
    link.href = '/assets/css/components/audioplayer.css';
...
function halloweenEasterEgg() {
    ...
    injectMusic("/assets/media/bgm/halloween/loading_playlist.opus");
}
...
function winterEasterEgg() {
    ...
    setupSnowflakes();
    injectMusic("/assets/media/bgm/xmas/loading_playlist.opus");
